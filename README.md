...
<img src="https://capsule-render.vercel.app/api?type=rect&color=3e80ed&height=2&width=100%" />
        ...
        <li><strong>LLM Database Reliability:</strong> Scaling and securing Vector and relational databases for high availability and performance.</li>
        ...
        <li><strong>DB Automation & Tooling: </strong> Developing custom tooling and alerts to automate sharding, indexing, and health checks, minimizing operational toil.</li>
